import { Menu, Download, Apple, Play, X, Facebook, Github, Mail, Lock } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-green-100/50 shadow-sm">
